"""Real-hardware counterpart of closed_loop_navigate.launch.py: real
Velodyne + real wheel feedback instead of Gazebo, otherwise the same
...
yaml, same as the sim version - see that file's comment) -> real UART
actuation, same real_navigate.launch.py contract (steering_uart_bridge ->
uart_sender_node, loopback:=true by default).
